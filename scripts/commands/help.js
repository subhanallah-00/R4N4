...
const siu = `❥͜͡𖠣꙰ٜٜٜٜٜٜٜٜٜ̋̀̋̀̋̀̋̀̋̀̋̀⚀ـٰٖٖٖٖٖٜ۬ـٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٜ۬ـٰٰٰٰٰٖٜ۬ 𝗔𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗮𝗹𝗮𝗶𝗸𝘂𝗺ـٰٖٖٖٖٖٜ۬ـٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٜ۬ـٰٰٰٰٰٖٜ۬⁜ٜٜٜٜٜٜٜٜٜ͜͡❥꙰ \nPage ｢${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}｣`;
 ...
 const text = `\n╭╼|════════════════|╾╮\n\n𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗟𝗜𝗦𝗧: ${arrayInfo.length}\n𝗕𝗢𝗧 𝗡𝗔𝗠𝗘: ${global.config.BOTNAME}\n𝗣𝗥𝗘𝗙𝗜𝗫  : ｢ ${global.config.PREFIX} ｣\n ✆ 𝗟𝗜𝗡𝗞 : wa.me/01752865115  \n ⓕ 𝗟𝗜𝗡𝗞 :https://facebook.com/RANA.IS.BUSY.OKAY \n\n╰╼|════════════════|╾╯ `; 
    var link = [
"https://i.imgur.com/wd2FTg0.jpeg",
      "https://i.imgur.com/wd2FTg0.jpeg",
      "https://i.imgur.com/wd2FTg0.jpeg",
