...
module.exports.run = async function ({ event, api, args, Currencies }) { 
  ...
  if (!two) return api.sendMessage("Please tag 1 person", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: `╭──────•◈•───────╮\n\n __ღ۵-🌺🦋“𝙉𝙚𝙫𝙚𝙧 𝙘𝙝𝙚𝙖𝙩 𝙨𝙤𝙢𝙚𝙤𝙣𝙚 𝙬𝙝𝙤 𝙘𝙡𝙤𝙨𝙚 𝙮𝙤𝙪𝙧 𝙚𝙮𝙚𝙨 𝙖𝙣𝙙 𝙗𝙚𝙡𝙞𝙚𝙫𝙚 𝙞𝙣 𝙮𝙤𝙪 𝙗𝙚𝙘𝙖𝙪𝙨𝙚 𝙥𝙚𝙤𝙥𝙡𝙚 𝙖𝙧𝙚 ⧼𝙡𝙪𝙘𝙠𝙮⧽.🍂🌻\n\n __ღ۵-🌺🦋“যে আপনাকে চোখ বন্ধ করে বিশ্বাস করে তাকে কোনোদিন ঠকাবেন না কারণ এমন মানুষ ভাগ্যবানেরাই পেয়ে থাকে।🍂🌻\n\n  𝗠𝗢𝗛𝗔𝗠𝗠𝗔𝗗 𝗥𝗔𝗡𝗔\n╰──────•◈•───────╯`, attachment: fs.createReadStream(path)}, threadID, () => fs.unlinkSync(path), messageID));
  }
}
